...
namespace ZDoomNavmesh
{
    public partial class FormViewer : Form
    {
        ...
        private void PanelViewer_Paint(object Sender, PaintEventArgs E)
        {
            ...
            {
                Point V1 = new Point((MapDefinition.MapVertex[MapLinedef.V1].X - MinX) / ScaleFactor, (MapDefinition.MapVertex[MapLinedef.V1].Y - MinY) / ScaleFactor);
                Point V2 = new Point((MapDefinition.MapVertex[MapLinedef.V2].X - MinX) / ScaleFactor, (MapDefinition.MapVertex[MapLinedef.V2].Y - MinY) / ScaleFactor);
            ...
            if (!(NavMesh is null))
                ...
                {
                    Point V1 = new Point((Line.A.X - MinX) / ScaleFactor, (Line.A.Y - MinY) / ScaleFactor);
                    Point V2 = new Point((Line.B.X - MinX) / ScaleFactor, (Line.B.Y - MinY) / ScaleFactor);
                    if (Line.Portal >= 0)
