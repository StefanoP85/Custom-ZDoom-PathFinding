...
class TMapDefinition:
	...
	def MapNamespaceText(self):
		if self.MapNamespace == MapNamespace.MapNamespaceDoom:
			return "Doom"
		elif self.MapNamespace == MapNamespace.MapNamespaceHexen:
			return "Hexen"
		elif self.MapNamespace == MapNamespace.MapNamespaceZDoom:
			return "ZDoom"
		else:
			return ""
